...
from networks import NormalNoise, UniformNoise, ImplicitPolicy, Critic, DiscriminatorWithoutSigmoid
...
from actor_critic_trainer import W1ACTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='./w1results/', type=str)                                    # Logging directory
    ...
    parser.add_argument('--fixed_rollout_len', default=3, type=int)
    ...
    # Setup Logging
    file_name = f"W1|{args.dataset}|Exp{args.ExpID}|{args.noise_type}|{args.noise_method}|noiD{args.noise_dim}|sigma{args.sigma}|upper{args.upper}|ll{args.log_lagrange}|pf{args.policy_freq}|lg{args.lmbda_gp}|{args.seed}"
    ...
    variant = vars(args)
    variant.update(version="MBW1|Implicit Policy")
